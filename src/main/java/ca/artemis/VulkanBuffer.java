...
public class VulkanBuffer {
    ...
    public void destroy(long allocator) {
        Vma.vmaDestroyBuffer(allocator, handle, allocationHandle);
    }
    ...
    public static class Builder {
        ...
        public VulkanBuffer build(long allocator) {
            try(MemoryStack stack = MemoryStack.stackPush()) {
                ...
                Vma.vmaCreateBuffer(allocator, pBufferCreateInfo, pAllocationCreateInfo, pBuffer, pAllocation, null);
