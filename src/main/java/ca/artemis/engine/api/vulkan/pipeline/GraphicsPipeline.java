...
import ca.artemis.engine.api.vulkan.descriptor.PushConstantRange;
...
public class GraphicsPipeline {
    ...
    public static class Builder {
        ...
        private long createPipelineLayout(VulkanDevice device, MemoryStack stack) {
            ...
            int result = VK11.vkCreatePipelineLayout(device.getHandle(), pPipelineLayoutCreateInfo, null, pPipelineLayout);
        ...
        public GraphicsPipeline build(VulkanDevice device) {
            try(MemoryStack stack = MemoryStack.stackPush()) {
                ...
                int result = VK11.vkCreateGraphicsPipelines(device.getHandle(), VK11.VK_NULL_HANDLE, pCreateInfos, null, pPipelines);
                if(result != VK11.VK_SUCCESS) {
