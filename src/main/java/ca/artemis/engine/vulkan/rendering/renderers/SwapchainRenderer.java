package ca.artemis.engine.vulkan.rendering.renderers;
...
import ca.artemis.engine.vulkan.rendering.FrameInfo;
import ca.artemis.engine.vulkan.rendering.programs.ShaderProgram;
...
public class SwapchainRenderer extends Renderer {
    ...
    public IntBuffer acquireNextSwapchainImage(MemoryStack stack, VulkanContext context, Window window, FrameInfo frameInfo) {
    ...
    public void recreateSwapchain(VulkanContext context, Window window) {
