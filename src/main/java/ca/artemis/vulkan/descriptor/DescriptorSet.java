...
public class DescriptorSet {
    ...
    public void updateDescriptorBuffer(VulkanContext context, VulkanBuffer buffer, long range, long offset, int binding, int descriptorType){
        try(MemoryStack stack = MemoryStack.stackPush()) {
            ...
            VK11.vkUpdateDescriptorSets(context.getDevice().getHandle(), pDescriptorWrites, null);
        }
    }

    public void updateDescriptorImageBuffer(VulkanContext context, VulkanImageView imageView, VulkanSampler sampler, int imageLayout, int binding, int descriptorType){
        try(MemoryStack stack = MemoryStack.stackPush()) {
