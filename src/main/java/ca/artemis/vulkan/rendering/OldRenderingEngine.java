...
public class OldRenderingEngine {
    ...
    private static final int maxInFlightFrames = 2;
    ...
    private final OldSwapchainRenderer oldSwapchainRenderer;

    private final SceneFramebufferObject sceneFramebufferObject;

    public OldRenderingEngine(VulkanContext context) {
        ...
        this.oldSwapchainRenderer = new OldSwapchainRenderer(this.context, this.commandPool, this.swapchain, this.textureImageView);
    ...
    public void mainLoop() {
        ...
        while (!context.getWindow().isCloseRequested()) {
            try(MemoryStack stack = MemoryStack.stackPush()) {
                currentFrame = frame % maxInFlightFrames;
                ...
                GLFW.glfwPollEvents();
                oldSwapchainRenderer.draw(context.getDevice(), swapchain);
    ...
    public void destroy() {
        sceneFramebufferObject.destroy(context);
        
        oldSwapchainRenderer.destroy(context);
