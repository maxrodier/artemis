...
public class SpriteSheetShaderProgram extends ShaderProgram {
    ...
    protected GraphicsPipeline createGraphicsPipeline(VulkanDevice device, RenderPass renderPass) {
        return new GraphicsPipeline.Builder()
            .addShaderModule(new ShaderModule(device, "shaders/spritesheet.vert", ShaderStageKind.VERTEX_SHADER))
            .addShaderModule(new ShaderModule(device, "shaders/spritesheet.frag", ShaderStageKind.FRAGMENT_SHADER))
