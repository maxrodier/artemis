...
public class SpriteSheetShaderProgram extends ShaderProgram {
    ...
    public SpriteSheetShaderProgram(RenderPass renderPass) {
        super(renderPass);
    }
    ...
    protected GraphicsPipeline createGraphicsPipeline(RenderPass renderPass) {
        return new GraphicsPipeline.Builder()
            .addShaderModule(new ShaderModule("src/main/resources/shaders/spritesheet.vert", ShaderStageKind.VERTEX_SHADER))
            .addShaderModule(new ShaderModule("src/main/resources/shaders/spritesheet.frag", ShaderStageKind.FRAGMENT_SHADER))
