...
public class SpriteSheetShaderProgram extends ShaderProgram {

    public SpriteSheetShaderProgram(VulkanDevice device, RenderPass renderPass) {
    ...
    protected GraphicsPipeline createGraphicsPipeline(VulkanDevice device, RenderPass renderPass) {
        return new GraphicsPipeline.Builder()
            .addShaderModule(new ShaderModule(device, "src/main/resources/shaders/spritesheet.vert", ShaderStageKind.VERTEX_SHADER))
            .addShaderModule(new ShaderModule(device, "src/main/resources/shaders/spritesheet.frag", ShaderStageKind.FRAGMENT_SHADER))
