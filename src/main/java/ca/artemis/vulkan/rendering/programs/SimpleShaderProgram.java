...
public class SimpleShaderProgram extends ShaderProgram {
    ...
    public SimpleShaderProgram(VulkanDevice device, RenderPass renderPass) {
    ...
    protected GraphicsPipeline createGraphicsPipeline(VulkanDevice device, RenderPass renderPass) {
        return new GraphicsPipeline.Builder()
            .addShaderModule(new ShaderModule(device, "src/main/resources/shaders/simple.vert", ShaderStageKind.VERTEX_SHADER))
            .addShaderModule(new ShaderModule(device, "src/main/resources/shaders/simple.frag", ShaderStageKind.FRAGMENT_SHADER))
