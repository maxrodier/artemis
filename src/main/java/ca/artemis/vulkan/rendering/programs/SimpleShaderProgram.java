...
public class SimpleShaderProgram extends ShaderProgram {
    ...
    public SimpleShaderProgram(RenderPass renderPass) {
        super(renderPass);
    }
    ...
    protected GraphicsPipeline createGraphicsPipeline(RenderPass renderPass) {
        return new GraphicsPipeline.Builder()
            .addShaderModule(new ShaderModule("src/main/resources/shaders/simple.vert", ShaderStageKind.VERTEX_SHADER))
            .addShaderModule(new ShaderModule("src/main/resources/shaders/simple.frag", ShaderStageKind.FRAGMENT_SHADER))
